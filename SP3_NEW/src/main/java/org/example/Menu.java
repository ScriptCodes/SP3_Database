...
public class Menu {
    ...
    FileIODatabase dIO = new FileIODatabase();
    ...
    public void loginMenu() {
        ...
        switch (loginOptions) {
            ...
            case "2":
                ...
                Streaming.createUser(uInputUsername, uInputPassword, isAdmin);
    ...
    public ArrayList<Movie> searchByGenreMovie() {
        ArrayList<Movie> matchingMovie = dIO.readMovieData();
    ...
    public ArrayList<Series> searchByGenreSeries() {
        ArrayList<Series> matchingSeries = dIO.readSeriesData();
        ui.displayMsg("Please enter the genre you're looking for");
